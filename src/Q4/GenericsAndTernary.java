...
public class GenericsAndTernary {
    ...
    public static void main(String[] args) {
        ...
        var box = new MyBox<Integer>(5); // "var" infers the type from the right-hand side
        // ONLY EVERY USE "var" IF YOU USE THE "new" KEYWORD
        // AND THE TYPE IS NOT A CHILD CLASS OR USES AND INTERFACE
        ...
        for (int i = 0; i < 1000000; i++) {
            ...
            if (i == 10) break; // Breaks out of the loop entirely (like return)
        }
